...
!function(){"use strict";function n(n,r,t,e,o){function i(){var n=[o.getStory()];return t.all(n).then(function(n){u.rows=n[0].layout.rows,u.hideSpinner=!0},function(n){alert(n)})}var u=this;u.hideSpinner=!1,i()}angular.module("app.frontend").filter("object2Array",function(){return function(n){var r=[];for(var t in n)r.push(n[t]);return r}}).controller("FrontendController",n),n.$inject=["$window","$state","$q","$scope","dataservice"]}();
...
!function(){"use strict";function t(t,e,r,o,n){function a(){function e(t){return t.data}function r(t){console.log("XHR Failed for getCommons.",t.data)}var n="?filter[fields][opengraph]=true";n+="&filter[fields][title]=true";var a=c+o+n;return t.get(a).then(e)["catch"](r)}function i(){function e(t){return t.data}function r(t){console.log("XHR Failed for getFooter.",t.data)}var n=c+o+"?filter[fields][footer]=true";return t.get(n).then(e)["catch"](r)}function l(){function e(t){return t.data}function r(t){console.log("XHR Failed for getStyles.",t.data)}var n=c+o+"?filter[fields][styleOptions]=true";return t.get(n).then(e)["catch"](r)}function u(){function e(t){return t.data}function r(t){return console.log("XHR Failed for getStory.",t.data),t.data}var n=c+o+"?filter[fields][layout]=true&filter[order]=rowOrder%20DESC";return t.get(n).then(e)["catch"](r)}var c;c=n.remote?"http://5.101.98.193:3000/api/stories/":"http://localhost:3000/api/stories/";var f={getCommons:a,getFooter:i,getStyles:l,getStory:u};return f}angular.module("app.core").factory("dataservice",t),t.$inject=["$http","$q","$filter","storyID","ENV"]}();
...
!function(){"use strict";function t(t,n,o,a,r,i){var p="/404";r.configureStates(e(),p);var l=[i.getCommons(),i.getStyles()];return o.all(l).then(function(e){n.title=e[0].title,n.primaryFont=e[1].styleOptions.type.primaryFont,n.secondaryFont=e[1].styleOptions.type.secondaryFont,n.style='body { font-family: "'+n.secondaryFont+'"; font-size: 1.8rem; }',n.style+='h1,h2,h3,h4,h5,h6 { font-family: "'+n.primaryFont+'" }',n.opengraph={image:"",title:n.title,url:a.$$absUrl,site_name:"",type:""},void 0!=e[0].opengraph&&(n.opengraph.image=e[0].opengraph.image,n.opengraph.site_name=e[0].opengraph.site_name,n.opengraph.type=e[0].opengraph.type);var o=[];for(var r in e[1].styleOptions.type)o.push(e[1].styleOptions.type[r]);t.WebFont.load({google:{families:o},active:function(){}})})}function e(){return[{state:"404",config:{url:"/404",templateUrl:"templates/404.html",title:"404"}}]}angular.module("app.core").run(t),t.$inject=["$window","$rootScope","$q","$location","routerHelper","dataservice"]}();
!function(){"use strict";angular.module("blocks.headline").directive("headline",["$window","$rootScope","$location","$document","$timeout",function(n,t,i,e,o){return{restrict:"AEC",templateUrl:"templates/blocks/headline/headline.html",replace:!0,scope:{counter:"="},link:function(r,a,l){var s=$(a).find(".headline-about-link-flag"),c=$(a).find(".headline-about-content"),h=$(a).find(".headline-logo"),d=$(a).find(".fb"),p=$(a).find(".tw"),f=$(a).find(".headline-scroll-down"),g=$(a).find(".headline-main-title-inner"),m=r.$parent.rowCtrl.optionsT[r.counter];r.options=m,a.parent()[0].style.padding=0,a.css({height:n.innerHeight+"px",backgroundImage:"url("+m.imgUrl+")"}),o(function(){s.css({fontFamily:t.primaryFont}),c.css({fontFamily:t.primaryFont}),h.css({width:m.logoWidth+"px",height:m.logoHeight+"px",backgroundImage:"url("+m.logoUrl+")"}),a.find("h1").css({fontFamily:'"'+t.primaryFont+'"'}),a.find("h4").css({fontFamily:'"'+t.secondaryFont+'"'}),console.log(t.primaryFont),a.find("a").css({fontFamily:t.primaryFont}).attr("target","blank"),d.attr("href","https://www.facebook.com/sharer/sharer.php?u="+i.$$absUrl),p.attr("href","http://twitter.com/share?url="+i.$$absUrl),g.css({marginTop:"-"+g.height()/2+"px"}).addClass("show")},!1),s.on("click",function(n){c.toggleClass("visible")}),f.on("click",function(t){e.scrollTop(n.innerHeight,500)}),n.onresize=function(t){a.css({height:n.innerHeight+"px"}),g.css({marginTop:"-"+g.height()/2+"px"})}}}}])}();
...
!function(){"use strict";angular.module("blocks.imgresponsive").directive("imgresponsive",["$sce",function(t){return{restrict:"AEC",template:'<div><img class="img-responsive" ng-src="{{ opt.imgUrl }}"><p class="img-caption" ng-bind-html="opt.caption"></p></div>',replace:!0,scope:{counter:"="},link:function(i,n,o){i.opt=i.$parent.rowCtrl.optionsT[i.counter],i.opt.caption=t.trustAsHtml(i.opt.caption)}}}])}();
!function(){"use strict";angular.module("blocks.rows").directive("rows",["$compile",function(r){return{restrict:"E",controller:function(){this.getOptions=function(){console.log(this)}},controllerAs:"rowCtrl",link:function(t,o,i){t.rowCtrl.optionsT=[],t.rowCtrl.htmlParamsT=[],t.rowCtrl.collectionsT=[],t.rowCtrl.switchesT=[],t.rowCtrl.radiosT=[];var e=0;t.rowStyles={},t.row.resetRowPadding&&(t.rowStyles.paddingLeft="0",t.rowStyles.paddingRight="0");var l="";l='<div class="row">',angular.forEach(t.row.layout,function(r,o){var i;i=r.mdoffset?" col-md-offset-"+r.mdoffset:"",l+='<div class="col-md-'+r.spanmd+i+'" ng-style="rowStyles">',l+="<"+r.directiveName,t.options=r.directiveOptions,t.htmlParams=r.directiveHtmlParams,t.rowCtrl.optionsT[e]=r.directiveOptions,t.rowCtrl.collectionsT[e]=r.directiveCollections,t.rowCtrl.htmlParamsT[e]=r.directiveHtmlParams,t.rowCtrl.switchesT[e]=r.directiveSwitches,t.rowCtrl.radiosT[e]=r.directiveRadios,angular.forEach(r.directiveHtmlParams,function(r,t){l+=" "+t+'="'+r+'"'}),l+=' counter="'+e+'"></'+r.directiveName+">",l+="</div>",e++}),l+="</div>";var s=r(l)(t);o.replaceWith(s)}}}])}();
