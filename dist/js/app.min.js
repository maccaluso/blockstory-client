...
!function(){"use strict";function t(t,n,o,r,i){var a="/404";r.configureStates(e(),a);var l=[i.getCommons(),i.getStyles()];return o.all(l).then(function(e){n.title=e[0].title,n.primaryFont=e[1].styleOptions.type.primaryFont,n.secondaryFont=e[1].styleOptions.type.secondaryFont,n.style='body { font-family: "'+n.secondaryFont+'"; font-size: 1.8rem; }',n.style+='h1,h2,h3,h4,h5,h6 { font-family: "'+n.primaryFont+'" }';var o=[];for(var r in e[1].styleOptions.type)o.push(e[1].styleOptions.type[r]);t.WebFont.load({google:{families:o},active:function(){}})})}function e(){return[{state:"404",config:{url:"/404",templateUrl:"templates/404.html",title:"404"}}]}angular.module("app.core").run(t),t.$inject=["$window","$rootScope","$q","routerHelper","dataservice"]}();
...
!function(){"use strict";function t(t,e,r,o,n){function a(){function e(t){return t.data}function r(t){console.log("XHR Failed for getQuestions."+t.data)}var n=s+o+"?filter[fields][styleOptions]=false&filter[fields][layout]=false";return t.get(n).then(e)["catch"](r)}function i(){function e(t){return t.data}function r(t){console.log("XHR Failed for getQuestions."+t.data)}var n=s+o+"?filter[fields][styleOptions]=true";return t.get(n).then(e)["catch"](r)}function l(){function e(t){return t.data}function r(t){console.log("XHR Failed for getQuestions."+t.data)}var n=s+o+"?filter[fields][layout]=true&filter[order]=rowOrder%20DESC";return t.get(n).then(e)["catch"](r)}var s;s=n.remote?"http://5.101.98.193:3000/api/stories/":"http://localhost:3000/api/stories/";var u={getCommons:a,getStyles:i,getStory:l};return u}angular.module("app.core").factory("dataservice",t),t.$inject=["$http","$q","$filter","storyID","ENV"]}();
...
!function(){"use strict";angular.module("blocks.bsbutton").directive("bsbutton",["$window",function(t){return{restrict:"AEC",templateUrl:"templates/blocks/bsbutton/bsbutton.html",replace:!0,scope:{counter:"="},link:function(t,o,i){var n={position:"fixed",top:0,left:0,"z-index":100},s={position:"fixed",bottom:0,left:0,"z-index":100};t.opt=t.$parent.rowCtrl.optionsT[t.counter],t.switches=t.$parent.rowCtrl.switchesT[t.counter],t.switches.stickToTop?t.bsButtonPosition=n:t.bsButtonPosition="{}",t.switches.stickToBottom?t.bsButtonPosition=s:t.bsButtonPosition="{}"}}}])}();
!function(){"use strict";angular.module("blocks.rows").directive("rows",["$compile",function(t){return{restrict:"E",controller:function(){this.getOptions=function(){console.log(this)}},controllerAs:"rowCtrl",link:function(r,o,i){r.rowCtrl.optionsT=[],r.rowCtrl.htmlParamsT=[],r.rowCtrl.collectionsT=[],r.rowCtrl.switchesT=[];var e=0,c="";c='<div class="row">',angular.forEach(r.row.layout,function(t,o){var i;i=t.mdoffset?" col-md-offset-"+t.mdoffset:"",c+='<div class="col-md-'+t.spanmd+i+'">',c+="<"+t.directiveName,r.options=t.directiveOptions,r.htmlParams=t.directiveHtmlParams,r.rowCtrl.optionsT[e]=t.directiveOptions,r.rowCtrl.collectionsT[e]=t.directiveCollections,r.rowCtrl.htmlParamsT[e]=t.directiveHtmlParams,r.rowCtrl.switchesT[e]=t.directiveSwitches,angular.forEach(t.directiveHtmlParams,function(t,r){c+=" "+r+'="'+t+'"'}),c+=' counter="'+e+'"></'+t.directiveName+">",c+="</div>",e++}),c+="</div>";var l=t(c)(r);o.replaceWith(l)}}}])}();
...
!function(){"use strict";angular.module("blocks.videoembed").directive("videoembed",["$window","youtubeApiService",function(e,t){return{restrict:"E",template:"<div></div>",replace:!0,scope:{counter:"="},link:function(e,o,r){function i(e,t){return new YT.Player(e.params.id,{playerVars:{autoplay:0,html5:1,theme:"light",modesbranding:1,color:"white",iv_load_policy:3,showinfo:0,controls:1},width:"100%",videoId:e.options.videoID})}switch(e.options=e.$parent.rowCtrl.optionsT[e.counter],e.params=e.$parent.rowCtrl.htmlParamsT[e.counter],e.options.videoHost){case"youtube":for(var n=document.getElementsByTagName("script"),a=!0,c=n.length;c--;)"https://www.youtube.com/iframe_api"==n[c].src&&(a=!1);if(a){var s=document.createElement("script");s.src="https://www.youtube.com/iframe_api";var u=document.getElementsByTagName("script")[0];u.parentNode.insertBefore(s,u)}var m;t.onReady(function(){m=i(e,o)});break;case"vimeo":}}}}])}();