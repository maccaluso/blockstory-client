...
!function(){"use strict";function t(t,e,o,r,n){function a(){function e(t){return t.data}function o(t){console.log("XHR Failed for getCommons."+t.data)}var n=c+r+"?filter[fields][styleOptions]=false&filter[fields][layout]=false";return t.get(n).then(e)["catch"](o)}function i(){function e(t){return t.data}function o(t){console.log("XHR Failed for getFooter."+t.data)}var n=c+r+"?filter[fields][footer]=true";return t.get(n).then(e)["catch"](o)}function l(){function e(t){return t.data}function o(t){console.log("XHR Failed for getStyles."+t.data)}var n=c+r+"?filter[fields][styleOptions]=true";return t.get(n).then(e)["catch"](o)}function f(){function e(t){return t.data}function o(t){console.log("XHR Failed for getStory."+t.data)}var n=c+r+"?filter[fields][layout]=true&filter[order]=rowOrder%20DESC";return t.get(n).then(e)["catch"](o)}var c;c=n.remote?"http://5.101.98.193:3000/api/stories/":"http://localhost:3000/api/stories/";var u={getCommons:a,getFooter:i,getStyles:l,getStory:f};return u}angular.module("app.core").factory("dataservice",t),t.$inject=["$http","$q","$filter","storyID","ENV"]}();
